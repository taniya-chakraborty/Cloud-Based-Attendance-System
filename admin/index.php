...
<div class="content">
  ...
  <div class="row" id="student">
      ...
      <input type="submit" class="btn btn-success col-md-2 col-md-offset-8" value="Add Student" name="std" />
    </form>
...
<br><br><br>
  <div class="rowtwo" id="teacher">
      ...
      <input type="submit" class="btn btn-success col-md-2 col-md-offset-8" value="Add Teacher" name="tcr" />
    </form>
