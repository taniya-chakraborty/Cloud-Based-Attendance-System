...
<div class="content">
    ...
    <h3>Recover your password</h3>
      ...
      <input type="submit" class="btn btn-success col-md-2 col-md-offset-10" value="Go" name="reset" />
    </form>
...
?>
  <strong>
  <p style="text-align: left;">Hi there!<br>You requested for a password recovery. You may <a href="index.php">Login here</a> and enter this key as your password to login. Recovery key: <mark><?php echo $dat['password']; ?></mark><br>Regards,<br>Cloud Based Attendance System</p></strong>
<?php
      }
          }
  }
